custom_imports = dict(
    imports=[
        ...
        'mmdet3d_plugin.hooks.per_epoch_lr',
...
# data_root = '/tudelft.net/staff-umbrella/IntelligentVehiclesPublicDatasets/nuscenes/'
...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['points', 'gt_bboxes_3d', 'gt_labels_3d'],
         meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                    ...
                    'prev_idx','next_idx','scene_token', 'lidar2ego_translation', 'lidar2ego_rotation'))
]
# test_pipeline = [
#     dict(
#         type='LoadPointsFromFile',
...
load_from = None
# load_from='/tudelft.net/staff-umbrella/rdramautar/ckpts/lidar_voxel0075_epoch20.pth'
