...
scenes = [
    'scene-0263', 'scene-0259', 'scene-0262', 'scene-0646', 'scene-0175',
    'scene-0643', 'scene-0255', 'scene-0166', 'scene-0174', 'scene-0640',
    'scene-0261', 'scene-0258', 'scene-0165', 'scene-0171', 'scene-0651',
    'scene-0161', 'scene-0173', 'scene-0172', 'scene-0164', 'scene-0639',
    'scene-0260', 'scene-0652', 'scene-0649', 'scene-0167', 'scene-0648',
    'scene-0257', 'scene-0254', 'scene-0168', 'scene-0647', 'scene-0645',
    'scene-0256', 'scene-0162', 'scene-0641', 'scene-0642', 'scene-0644',
    'scene-0163', 'scene-0170', 'scene-0264', 'scene-0176', 'scene-0650'
]
plugin = True
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            enable_hfl=True,
            scenes=[
                'scene-0263', 'scene-0259', 'scene-0262', 'scene-0646',
                'scene-0175', 'scene-0643', 'scene-0255', 'scene-0166',
                'scene-0174', 'scene-0640', 'scene-0261', 'scene-0258',
                'scene-0165', 'scene-0171', 'scene-0651', 'scene-0161',
                'scene-0173', 'scene-0172', 'scene-0164', 'scene-0639',
                'scene-0260', 'scene-0652', 'scene-0649', 'scene-0167',
                'scene-0648', 'scene-0257', 'scene-0254', 'scene-0168',
                'scene-0647', 'scene-0645', 'scene-0256', 'scene-0162',
                'scene-0641', 'scene-0642', 'scene-0644', 'scene-0163',
                'scene-0170', 'scene-0264', 'scene-0176', 'scene-0650'
            ],
            scene_translation=
...
log_level = 'INFO'
work_dir = '/tudelft.net/staff-umbrella/rdramautar/HFL/experiments/exp_042'
load_from = None
resume_from = None
workflow = [('train', 1)]
gpu_ids = [0]
