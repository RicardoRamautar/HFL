...
def main():
    ...
    cloud = Coordinator(
        work_root = "/tudelft.net/staff-umbrella/rdramautar/HFL/experiments/exp_045",
        ...
        manifest_path = "/tudelft.net/staff-umbrella/rdramautar/HFL/data/highly_non_iid_025.json",
        init_ckpt_path = None,
