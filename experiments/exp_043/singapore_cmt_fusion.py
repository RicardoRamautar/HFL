...
scenes = [
    'scene-1050', 'scene-1052', 'scene-1058', 'scene-0002', 'scene-1044',
    'scene-0792', 'scene-1046', 'scene-0001', 'scene-0005', 'scene-0791',
    'scene-1055', 'scene-0790', 'scene-0006', 'scene-1054', 'scene-0789',
    'scene-1047', 'scene-1057', 'scene-1056', 'scene-1048', 'scene-0010',
    'scene-1051', 'scene-1053', 'scene-0786', 'scene-0008', 'scene-0009',
    'scene-0007', 'scene-0787', 'scene-1049', 'scene-0004', 'scene-1045',
    'scene-0011'
]
plugin = True
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            enable_hfl=True,
            scenes=[
                'scene-1050', 'scene-1052', 'scene-1058', 'scene-0002',
                'scene-1044', 'scene-0792', 'scene-1046', 'scene-0001',
                'scene-0005', 'scene-0791', 'scene-1055', 'scene-0790',
                'scene-0006', 'scene-1054', 'scene-0789', 'scene-1047',
                'scene-1057', 'scene-1056', 'scene-1048', 'scene-0010',
                'scene-1051', 'scene-1053', 'scene-0786', 'scene-0008',
                'scene-0009', 'scene-0007', 'scene-0787', 'scene-1049',
                'scene-0004', 'scene-1045', 'scene-0011'
            ],
            scene_translation=
...
log_level = 'INFO'
work_dir = '/tudelft.net/staff-umbrella/rdramautar/HFL/experiments/exp_043'
load_from = None
resume_from = '/tudelft.net/staff-umbrella/rdramautar/HFL/experiments/exp_043/epoch_4.pth'
workflow = [('train', 1)]
gpu_ids = [0]
